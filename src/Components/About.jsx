      ...
      <div className=" flex flex-col md:flex-row justify-center px-2 md:pr-10 md:gap-10 lg:gap-0 md:pl-5 items-center md:items-center">
        <div className="h-[520px] w-[400px] aspect-[3/2] object-contain lg:w-[452px] md:mr-10 flex justify-center items-center">
          <img
            src={about}
            alt="About-Img"
            className="h-[500px] w-[400px] pr-2 object-cover object-top"
          />
        </div>
        <div className=" flex flex-col gap-4 justify-center items-center">
          <h2 className=" text-[#FF9999] meri font-bold text-xl">About Me</h2>
          <h1 className=" text-[#1A0F0F] font-bold text-xl meriB">
            SIMRAN DUDEJA
          </h1>
          ...
          <div className=" text-lg text-wrap w-fit pl-5 pr-5 lg:w-[600px] md:w-[300px]  leading-6">
            ...
            <p className=" pb-3">
              ...
              have a vision to change people's perspectives about makeup.
            </p>
            <p className=" pb-3">
