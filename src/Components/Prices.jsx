...
const Prices = () => {
  return (
    <div className="mb-10 lg:mb-20" id="Prices">
      {" "}
      {/* Adjust margin bottom */}
      <div className="mt-20">
        <div className="mb-10 flex flex-col justify-center items-center">
          <h2 className="text-xl font-semibold pb-5 text-[#FF9999] meriR">
            PRICES
          </h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center flex-wrap gap-8 px-4">
          <img
            src={PricesB}
            className="md:h-[350px] h-[250px] object-fit md:w-[550px] w-full p-5 aspect-[1/2]"
            alt="price-img"
          />
          <img
            src={PricesE}
          ...
          <img
            src={PricesP}
            className="md:h-[350px] h-[250px] object-cover md:w-[550px] w-full p-5 aspect-[1/2]"
            alt="price-img"
          />
          <img
            src={PricesH}
